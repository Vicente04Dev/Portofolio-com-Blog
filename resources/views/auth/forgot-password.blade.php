            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b>Redifinir senha</b></h4>
    
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('password.email') }}">
                                @csrf
                                <div class="alert alert-info alert-dismissible fade show" role="alert">
                                Esqueceu sua senha? Sem problemas. Deixe seu <strong>e-mail</strong> e nós iremos enviar um link que vai te permitir redifinir uma nova palavra-passe.
